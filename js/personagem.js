...
pegarPersonagem = () => {
    ...
    buscarInformacaoPersonagem(numeroAleatorio1, imagem1, nomeDoPersonagem1, especie1, condicao1);
    buscarInformacaoPersonagem(numeroAleatorio2, imagem2, nomeDoPersonagem2, especie2, condicao2);
    buscarInformacaoPersonagem(numeroAleatorio3, imagem3, nomeDoPersonagem3, especie3, condicao3);
}

buscarInformacaoPersonagem = (numeroAleatorio, imagem, nome, especie, condicao) => {
